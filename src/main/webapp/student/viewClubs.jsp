                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <form action="/student/clubs/register" method="post">
                                        ...
                                        <tbody>
                                            <%
                                                ...
                                                if (clubs != null && !clubs.isEmpty()) {
                                                    ...
                                                    String semesterName = clubsDAO.getSemesterNameByClubID(club.getClubID()); // Move inside the loop to ensure it's updated for each club
                                            %>
                                            <tr>
                                                <td>
                                                    <div class="date">
